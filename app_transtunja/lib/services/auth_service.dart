...
class AuthService {
  ...
  Future<void> enviarCodigoVerificacion({
    ...
    String? nombreParaSaludo, // <--- SE AGREGA ESTE PARÁMETRO PARA QUITAR EL ERROR
  }) async {
    try {
      ...
      await _auth.verifyPhoneNumber(
        ...
        codeSent: (id, token) {
          // SE ENVÍA EL NOMBRE A TRAVÉS DE LOS ARGUMENTOS HACIA VERIFICATION SCREEN
          Navigator.pushNamed(
            context,
            '/verification',
            arguments: {
              'verificationId': id, 
              'userData': userData,
              'nombreUsuario': nombreParaSaludo ?? "Usuario", // <--- SE PASA AQUÍ
            },
          );
        },
